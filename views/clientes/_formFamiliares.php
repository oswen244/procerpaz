...
<div class="familiares-form">
    ...
    <div class="form-group field-familiares-fecha_nacimiento">
        <div class="form-group field-familiares-fecha_nacimiento">
            ...
            <div class="col-sm-6">
                <?= yii\jui\DatePicker::widget(["id" => "familiares-fecha_nacimiento", "name" => "Familiares[fecha_nacimiento]", "dateFormat" => "yyyy-MM-dd", 'options' => ['class' => 'fecha form-control', "placeholder" => "aaaa-mm-dd"], 'clientOptions'=>['yearRange'=>$rango_fecha, 'changeMonth'=>'true', 'changeYear'=>'true'], 'language'=>'es'])?>
            </div>            
        </div>
    </div>
